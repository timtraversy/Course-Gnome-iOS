...
@IBDesignable open class RangeSlider: UIControl {
  ...
  func addContentViews(){
    ...
    lowerLabel.font = UIFont(name: "AvenirNext-Medium", size: labelFontSize)
  ...
  open func updateLabelText() {
    ...
    lowerLabelTextSize = (lowerLabel.string as! NSString).size(withAttributes: [NSAttributedStringKey.font : UIFont(name: "AvenirNext-Medium", size: labelFontSize)!])
    upperLabelTextSize = (upperLabel.string as! NSString).size(withAttributes: [NSAttributedStringKey.font : UIFont(name: "AvenirNext-Medium", size: labelFontSize)!])
  }
  ...
  open func updateLabelPositions() {
    ...
    upperLabel.frame = CGRect(x: 0, y: 0, width: upperLabelTextSize.width+1, height: upperLabelTextSize.height)
